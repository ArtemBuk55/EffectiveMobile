...
import com.example.effectivemobile.ui.items.MemoryItem
...
class MemoryAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private var memoryList: MutableList<MemoryItem> = mutableListOf()

    fun addMemoryList(memoryList: MutableList<MemoryItem>) {
