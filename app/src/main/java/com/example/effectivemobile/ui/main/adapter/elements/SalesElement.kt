package com.example.effectivemobile.ui.main.adapter.elements
...
data class CategoriesElement(val categoryList: List<CategoryItem>) : AdapterElement("sales_categories_block")
