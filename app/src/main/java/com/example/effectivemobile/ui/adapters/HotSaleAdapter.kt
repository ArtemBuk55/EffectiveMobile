...
import com.example.effectivemobile.ui.items.HotSaleItem
...
class HotSaleAdapter(private val openDetailsActivityCallback: () -> Unit) :
    ...
    private var hotSalesList: MutableList<HotSaleItem> = mutableListOf()

    fun addHotSales(hotSalesList: MutableList<HotSaleItem>) {
