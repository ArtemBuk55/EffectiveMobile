...
import com.example.effectivemobile.ui.items.BestSellerItem
...
class BestSellerAdapter(private val openDetailsActivityCallback: () -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private var bestSellerList: MutableList<BestSellerItem> = mutableListOf()

    fun addBestSeller(bestSellerList: MutableList<BestSellerItem>) {
